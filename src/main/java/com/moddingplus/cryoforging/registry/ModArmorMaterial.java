...
public enum  ModArmorMaterial implements IArmorMaterial {
    ICE_CROWN("ice_crown", 33, new int[]{3, 0, 0, 0}, 15, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 3.0f, () -> {
        return Ingredient.fromItems(Registries.getItem("frost_gold"));
    });

    /**
     * Vanilla implementation copied from ArmorMaterial
     */
